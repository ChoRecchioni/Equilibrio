...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="Contenedor" style="margin-top: 40px;">
        ...
        <asp:TextBox class="Txt" Style="float: left;" ID="TxtBuscar" runat="server" placeholder="CLIENTE"></asp:TextBox>
        ...
        <asp:Label class="TxtTitulo" ID="Label1" runat="server" Text="FECHA:"></asp:Label>
        <asp:Label class="TxtTitulo" ID="LblFecha1" runat="server" Text=""></asp:Label>
                </td>
                <td class="auto-style3">
        <asp:Label class="TxtTitulo" ID="Label6" runat="server" Text="HORA:"></asp:Label>
        <asp:Label class="TxtTitulo" ID="LblHora1" runat="server" Text=""></asp:Label>
                </td>
                <td class="auto-style3">
        <asp:Label class="TxtTitulo" ID="Label2" runat="server" Text="N° COMENSALES:"></asp:Label>
        <asp:Label class="TxtTitulo" ID="LbComensales1" runat="server" Text=""></asp:Label></td>
