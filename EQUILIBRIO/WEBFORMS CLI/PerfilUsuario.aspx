                    ...
                    <tr style="height: 10px;">
                        ...
                        <td class="auto-style2">
                            <asp:UpdatePanel ID="UPC" runat="server">
                                <ContentTemplate>
                                    <asp:DropDownList ID="DropRegion" CssClass="DropPerfil" Enabled="false" runat="server" OnSelectedIndexChanged="DropRegion_SelectedIndexChanged" AutoPostBack="true">
                                    </asp:DropDownList>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                    ...
                    <tr style="height: 10px;">
                        ...
                        <td class="auto-style2">
                            <asp:UpdatePanel ID="UPR" runat="server">
                                <ContentTemplate>
                                    <asp:DropDownList ID="DropComuna" CssClass="DropPerfil" Enabled="false" runat="server">
                                    </asp:DropDownList>
                                </ContentTemplate>
                                <Triggers>
